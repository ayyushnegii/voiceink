# VoiceInk Technical Reference for AI Assistants

This document provides comprehensive technical details about the VoiceInk project architecture for AI assistants working on the codebase.

## Project Overview

VoiceInk is an Electron-based desktop dictation application that uses OpenAI Whisper for speech-to-text transcription. It supports both local (privacy-focused) and cloud (OpenAI API) processing modes.
