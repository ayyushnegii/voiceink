        ...
        return (
          <div className="space-y-6">
            <div className="text-center">
              ...
              <p className="text-gray-600">
                VoiceInk needs a couple of permissions to work properly
              </p>
            </div>
            ...
            <div className="bg-amber-50 p-4 rounded-lg">
              ...
              <p className="text-sm text-amber-800">
                VoiceInk only uses these permissions for dictation.
                {useLocalWhisper
          ...
          >
            <div className="text-center">
              ...
              <p
                ...
                style={{ fontFamily: "Noto Sans, sans-serif" }}
              >
                Let's test your setup and practice using VoiceInk
              </p>
            </div>
        ...
        return (
          <div className="text-center space-y-6">
            ...
            <div>
              ...
              <p className="text-gray-600">
                VoiceInk is now configured and ready to use.
              </p>
            </div>
