          ...
          <div className="space-y-8">
            ...
            <div className="space-y-6">
              <div>
                ...
                <p className="text-sm text-gray-600 mb-4">
                  Keep VoiceInk up to date with the latest features and
                  improvements.
                </p>
              </div>
            ...
            <div className="border-t pt-8">
              <div>
                ...
                <p className="text-sm text-gray-600 mb-6">
                  VoiceInk converts your speech to text using AI. Press your
      ...
      case "transcription":
        return (
          <div className="space-y-6">
            ...
            <div className="space-y-4 p-4 bg-gradient-to-r from-orange-50 to-white border border-orange-200 rounded-xl">
              <div className="flex items-center justify-between">
                <div>
                  <h4 className="font-medium text-gray-900">Hinglish Mode 🇮🇳</h4>
                  <p className="text-sm text-gray-600 mt-1">
                    Optimize transcription for Hindi-English code-switching. 
                    Best with Hindi language or Auto-detect.
                  </p>
                </div>
                <Toggle
                  checked={hinglishMode}
                  onChange={(checked) => {
                    setHinglishMode(checked);
                    updateTranscriptionSettings({ hinglishMode: checked });
                  }}
                />
              </div>
            </div>
        ...
        return (
          <div className="space-y-6">
            <div>
              ...
              <p className="text-sm text-gray-600 mb-6">
                View and customize the prompts that power VoiceInk's AI text processing. 
